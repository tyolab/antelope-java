...
public class AntelopeRemoteClient {
	...
	private static AntelopeRemoteClient instance;
	...
	public static AntelopeRemoteClient getInstance() {
		if (instance == null)
			instance = new AntelopeRemoteClient();
		return instance;
	}
...
//			out.writeBytes(query + "\n");
	...
	public static void main(String[] args) {
		AntelopeRemoteClient.dylibName = "atire_jni";
	    System.loadLibrary(dylibName);
		
		AntelopeRemoteClient atire = new AntelopeRemoteClient();
